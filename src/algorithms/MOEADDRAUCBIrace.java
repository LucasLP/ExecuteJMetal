...
public class MOEADDRAUCBIrace extends MOEADDRA {
    String name = "";
  ...
  public void run() {
    ...
    /**/
     /* System.out.println("\n");
      for (int i = 0; i < 100; i++) {
          System.out.println(sumOfEvolution[i]);
      }*/
  ...
  private void ucb_configuration3(Integer i){
      switch(i){
            ...
            case 10:
                ...
                break;
            case 11:
               // setConfig(0.02, 7,0.06, 0.88, "rand/1/bin");//300
                 setConfig(0.03, 3, 0.13, 0.27, "rand/1/bin");//300
                break;
      }
  }
