...
public class IBEA<S extends Solution<?>> implements Algorithm<List<S>>, HistoricAlgorithm {
    ...
    while (evaluations < maxEvaluations) {
      ...
      while (offSpringSolutionSet.size() < populationSize) {
        ...
        if(HistoricAlgorithm.testToCalculate(evaluations,maxEvaluations)){
            HistoricAlgorithm.calculateIndicators(evaluations, maxEvaluations, problem.getName(), (List<DoubleSolution>) offSpringSolutionSet,history);
        }
      }
  ...
  @Override public List<S> getResult() {
    return archive;//SolutionListUtils.getNondominatedSolutions(archive);
  }
