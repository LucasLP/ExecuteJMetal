# Read data file
algorithm1 <- read.table("data_HV_MOEADDRA_UF1.dat", header=T, sep="\t") 
algorithm2 <- read.table("data_HV_MOEADDRAUCB_UF1.dat", header=T, sep="\t") 
algorithm3 <- read.table("data_HV_MOEADDRAUCBIrace_UF1.dat", header=T, sep="\t") 
...
title(main="Quality Indicator Evolution for UF1", font.main=4)
