 ...
 */
public class MOEAD_DRA_UCBv1_main {
  ...
  public static void main(String [] args) throws JMException, SecurityException, IOException, ClassNotFoundException {
    ...
    if (args.length == 1) {
      ...
      indicators = new QualityIndicator(problem, args[1]) ;
        ...
        //problem = new Kursawe("Real", 2); //Modificado
    ...
    indicators = new QualityIndicator(problem, "paretoFront"+File.separator+"WFG8.dat") ;
    algorithm = new MOEAD_DRA_UCBv1(problem);
    ...
    algorithm.setInputParameter("dataDirectory",
    //"/media/lucas/Dados/Faculdade/Iniciação Ciêntifica II-Evolução Diferencial Multiobjetivo/IC/weight");
            "weight");

    algorithm.setInputParameter("finalSize", 600) ; // used by MOEAD_DRA
