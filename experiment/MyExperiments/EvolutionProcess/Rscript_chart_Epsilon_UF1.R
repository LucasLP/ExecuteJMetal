# Read data file
algorithm1 <- read.table("../history/MOEADDRA/data_Epsilon_MOEADDRA_UF1.dat", header=T, sep="\t") 
algorithm2 <- read.table("../history/MOEADDRAUCB/data_Epsilon_MOEADDRAUCB_UF1.dat", header=T, sep="\t") 
algorithm3 <- read.table("../history/MOEADDRAUCBIrace/data_Epsilon_MOEADDRAUCBIrace_UF1.dat", header=T, sep="\t") 
...
title(main="Quality Indicator Epsilon for UF1", font.main=4)

# Label the x and y axes
title(xlab= "% of Evolutions")
title(ylab= "Epsilon value")
